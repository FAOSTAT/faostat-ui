...
$(function() {
   ...
   $.widget("unc.jbPivot", {
      ...
      collapseAllButtton:function(){
	  for (var i=0;i<$(this.options.InternalID+" .collapse_button").length;i++)
          {$(this.options.InternalID).data("unc-jbPivot")._togleCollapse($(this.options.InternalID+" .collapse_button")[i].getAttribute("rel"));}}
      ,
      reset: function() {
         this.fields = [];
         this.afields = [];
      ...
      _renderHtml: function() {
         ...
         var S = "";
         S += "<table border='0px' cellspacing='0' cellpadding='0' class='unused_fields'>";
         S+="<tr><th><button onclick=\"$(\'"+this.options.InternalID+"\').data(\'unc-jbPivot\').collapseAllButtton()\">Collapse all</button></th></tr>" ;
         S+="<tr><th class='unused_field dropable targetU0' rel='U,0'>" + this.options.l_unused_fields + "</th>";
