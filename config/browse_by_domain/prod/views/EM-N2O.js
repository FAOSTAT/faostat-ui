                    ...
                    labels: {
                        ...
                        template: {
                            title: {
                                ...
                                fr: "Parts par pays du secteur {{item}} dans les émissions de N<sub>2</sub>O",
                                es: "Cuotas por país del sector {{item}} en las emisiones de N<sub>2</sub>O"
                            },
                    ...
                    labels: {
                        ...
                        template: {
                            title: {
                                ...
                                fr: "Parts des secteurs agricoles dans les émissions de N<sub>2</sub>O",
                                es: "Cuotas de los sectores agrícolas en las emisiones de N<sub>2</sub>O"
                            },
                    ...
                    labels: {
                        template: {
                            title: {
                                ...
                                fr: "Part de chaque secteur dans les émissions de N<sub>2</sub>O",
                                es: "Cuota de cada sector en las emisiones de N<sub>2</sub>O"
                            },
