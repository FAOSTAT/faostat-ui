            ...
            items: [
                ...
                },
                {
                    ...
                    labels: {
                        ...
                        template: {
                            title: {
                                en: "Top 10 areas by emissions intensity, {{item}}",
                                fr: "Principaux 10 pays par intensité des émissions, {{item}}",
                                es: "Principales 10 países por intensidad de emisiones, {{item}}"
                            },
                            subtitle: "{{#isMultipleYears year aggregation}}{{/isMultipleYears}}{{year}}"
                        }
                    },
