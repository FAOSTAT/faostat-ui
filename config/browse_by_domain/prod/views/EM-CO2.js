                    ...
                    labels: {
                        ...
                        template: {
                            title: {
                                ...
                                fr: "Parts par pays du secteur {{item}} dans les émissions de CO<sub>2</sub>",
                                es: "Cuotas por país del sector {{item}} en las emisiones de CO<sub>2</sub>"
                            },
                    ...
                    labels: {
                        ...
                        template: {
                            title: {
                                ...
                                fr: "Parts des secteurs agricoles dans les émissions de {gaz}",
                                es: "Cuotas de los sectores agrícolas en las emisiones de {gas}"
                            },
                    ...
                    labels: {
                        template: {
                            title: {
                                ...
                                fr: "Part de chaque secteur dans les émissions de CO<sub>2</sub>",
                                es: "Cuota de cada sector en las emisiones de CO<sub>2</sub>"
                            },
