...
define(['jquery', 'i18n!nls/common'], function ($, Common) {
    ...
    return $.extend(true, {}, Common, {
        ...
        all_faostat_data: "Все данные FAOSTAT",
        ...
        explore_data_text: "FAOSTAT предоставляет бесплатный доступ к собранным с 1961 до предыдущего года данным более 245 стран и территорий в области продовольствия и сельского хозяйства, которые охватывают все региональные группы ФАО."
