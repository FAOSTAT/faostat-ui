...
define(['jquery', 'q'], function ($, Q) {
    ...
    if (this.is_valid_data(config)) {
            return Q($.ajax({
                ...
                traditional: true,
                data: {
    "datasource": config.datasource, "output_type": config.output_type, "api_key": config.api_key, "client_key": config.client_key, "domain_code": config.domain_code, "list_1_codes": config.list_1_codes, "list_2_codes": config.list_2_codes, "list_3_codes": config.list_3_codes, "list_4_codes": config.list_4_codes, "list_5_codes": config.list_5_codes, "list_6_codes": config.list_6_codes, "list_7_codes": config.list_7_codes, "null_values": config.null_values, "thousand_separator": config.thousand_separator, "decimal_separator": config.decimal_separator, "decimal_places": config.decimal_places, "limit": config.limit
},
                type: 'GET'
            }));
    }
...
RESTClient.prototype.is_valid_data = function(config) {
    var parameters = ["datasource", "output_type", "api_key", "client_key", "lang", "domain_code", "list_1_codes", "list_2_codes", "list_3_codes", "list_4_codes", "list_5_codes", "list_6_codes", "list_7_codes", "null_values", "thousand_separator", "decimal_separator", "decimal_places", "limit"], i;
...
RESTClient.prototype.apply_data_defaults = function (config) {
    var i,
        parameters = ["datasource", "output_type", "api_key", "client_key", "lang", "domain_code", "list_1_codes", "list_2_codes", "list_3_codes", "list_4_codes", "list_5_codes", "list_6_codes", "list_7_codes", "null_values", "thousand_separator", "decimal_separator", "decimal_places", "limit"],
        defaults = {
            "datasource": "production", "output_type": "objects", "api_key": "n.a.", "client_key": "n.a.", "lang": "en", "null_values": "false", "thousand_separator": ",", "decimal_separator": ".", "decimal_places": "2", "limit": "-1"
        },
        key;
    for (i = 0; i < parameters.length; i += 1) {
        key =  parameters[i];
