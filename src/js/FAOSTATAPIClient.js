...
define(['jquery', 'q'], function ($, Q) {
    ...
    if (this.is_valid_data(config)) {
        return Q($.ajax({
            ...
            data: {
    "datasource": config.datasource, "output_type": config.output_type, "api_key": config.api_key, "client_key": config.client_key, "domain_code": config.domain_code, "List1Codes": config.List1Codes, "List2Codes": config.List2Codes, "List3Codes": config.List3Codes, "List4Codes": config.List4Codes, "List5Codes": config.List5Codes, "List6Codes": config.List6Codes, "List7Codes": config.List7Codes, "null_values": config.null_values, "thousand_separator": config.thousand_separator, "decimal_separator": config.decimal_separator, "decimal_places": config.decimal_places, "limit": config.limit
},
            type: 'POST'
        }));
    }
