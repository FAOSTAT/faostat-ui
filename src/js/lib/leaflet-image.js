...
// leaflet-image
    module.exports = function leafletImage(map, callback) {
        ...
        try {
            ...
            console.log("asiudhasidhasouygdsauoiygdsa")
            console.error(e);
        }

        function drawTileLayer(l) {
            console.log("drawTileLayer", l)
        ...
        function handleTileLayer(layer, callback) {
            ...
            console.log("handleTileLayer", layer)
            ...
            function loadTile(url, tilePos, tileSize, callback) {
                ...
                console.log("loadTile", url, tilePos, tileSize)
            ...
            function tileQueueFinish(err, data) {
                ...
                console.log("tileQueueFinish", data)
